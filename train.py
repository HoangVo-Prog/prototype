...
if __name__ == '__main__':
    ...
    logger.info(
        "Checkpoint scope | --load_backbone_ckpt strictly loads all non-prototype weights | --load_prototype_ckpt strictly loads all prototype-related weights | --save_backbone_ckpt saves all non-prototype weights"
    )
    model.to(device)
    if args.distributed:
